...
var RegistroAutomotor = /** @class */ (function () {
    function RegistroAutomotor() {
        this.autos = [];
        this.filetxt = new LectorArchivos_1.default();
    }
    ...
    RegistroAutomotor.prototype.updateAuto = function (patenteVieja) {
        ...
        var modelo = RLS.question('Ingrese el modelo nuevo: ');
        var año = RLS.questionInt('Ingrese el año nuevo: ');
    ...
    RegistroAutomotor.prototype.cargarAutos = function (rutaArchivo, separador) {
        var _this = this;
        var autos = this.filetxt.LeerArchivo(rutaArchivo, separador);
        var propiedadesAuto = [];
