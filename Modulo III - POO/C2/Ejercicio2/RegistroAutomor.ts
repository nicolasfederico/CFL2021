...
import file from './LectorArchivos';
...
export default class RegistroAutomotor {
    ...
    public updateAuto(patenteVieja: string): void{
        ...
        let modelo:string = RLS.question('Ingrese el modelo nuevo: ');
        let año: number = RLS.questionInt('Ingrese el año nuevo: ');
    ...
    cargarAutos(rutaArchivo:string, separador:string):void{
